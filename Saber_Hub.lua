...
local H EUI = get_hidden_gui or gethui
...
function Notif.New(text, timee)
    ...
    image_button.Image = "rbxassetid://16722272371"
...
function Update:Window(text,logo,keybind)
  ...
  --  UserImage.BackgroundColor3 = Color3.fromRGB(225, 225, 225)
	...
	Logo.Image = "rbxassetid://16722272371"
...
local Library = Update:Window("Saber Hub","",Enum.KeyCode.RightControl);
